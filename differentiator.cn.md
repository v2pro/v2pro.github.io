...
* 微服务模板生成：在线业务的微服务可以分成“配置”，“存储”，“流程”和“智能”四类。提供平台使得四类微服务共性的部分可以下沉，使得写业务的同学可以专注于业务逻辑本身。
* 迁移辅助工具：对于遗留应用，改代码的成本是非常高的。如果没有辅助手段，很难升级改造。通过在网络层分析流量，在不改动原有代码的情况下，实现类似单元测试覆盖的效果。

# 基础组件

基础组件就是一些Go的Library。也支持 PHP 运行在 Go 上。
...
框架模式，业务逻辑以插件的方式托管到平台上，快速实现新的微服务。
...
Accessor的抽象模型是能够快速地支持各种协议编解码的关键。
